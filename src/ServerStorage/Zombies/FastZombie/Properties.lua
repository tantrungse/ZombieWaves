local self = {
	...
	ChaseSpeed = 20, -- how fast the zombie walks when it sees a player
	WanderSpeed = 12, -- how fast the zombie walks when it's just wandering
	...
	DamagePerHit = 6, -- self-explanatory
	...
	MoneyDrop = {Min = 7, Max = 13}, -- how much money (randomly) our zombie will give when killed
