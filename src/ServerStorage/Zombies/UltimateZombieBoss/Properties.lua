local self = {
	...
	-- Zombie stats
	HumanoidStats = {
		MaxHealth = 7000, -- max possible health
		Health = 7000, -- starting health
		JumpPower = 35,
	},
	ChaseSpeed = 15, -- how fast the zombie walks when it sees a player
	WanderSpeed = 6, -- how fast the zombie walks when it's just wandering

	RegeneratesHealth = true, -- Should the zombie regenerate health?
	HealthRegenAmount = 10, -- how much health should regen
	HealthRegenTick = 1, -- how long to wait in seconds before healing again
	HealthRegenLimit = 0.3, -- decimal representing the percentage of MaxHealth will be healed to
	...
	DamagePerHit = 60, -- self-explanatory
	CooldownBetweenAttack = 3, -- how many seconds to wait in between attacks
	...
	MoneyDrop = {Min = 90, Max = 125}, -- how much money (randomly) our zombie will give when killed
	...
	AgentParams = {
		AgentRadius = 2.75, -- the minimum width separation between two parts that our zombie can walk through, the default diameter of an R15 is 4 studs, so the radius is 2
		AgentHeight = 7, -- the minimum height separation between two parts that our zombie can walk through, the default height of an R15 character is 5 studs
