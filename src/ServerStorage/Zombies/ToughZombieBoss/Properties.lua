local self = {
	...
	-- Zombie stats
	HumanoidStats = {
		MaxHealth = 2500, -- max possible health
		Health = 2500, -- starting health
		JumpPower = 35,
	},
	...
	DamagePerHit = 80, -- self-explanatory
	CooldownBetweenAttack = 4, -- how many seconds to wait in between attacks
	...
	MoneyDrop = {Min = 35, Max = 50}, -- how much money (randomly) our zombie will give when killed
