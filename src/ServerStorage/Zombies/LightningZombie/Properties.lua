local self = {
	...
	-- Zombie stats
	HumanoidStats = {
		MaxHealth = 60, -- max possible health
		Health = 60, -- starting health
		JumpPower = 50,
	},
	ChaseSpeed = 30, -- how fast the zombie walks when it sees a player
	WanderSpeed = 18, -- how fast the zombie walks when it's just wandering
	
	RegeneratesHealth = false, -- Should the zombie regenerate health?
	HealthRegenAmount = 1, -- how much health regen per second
	...
	DamagePerHit = 5, -- self-explanatory
	CooldownBetweenAttack = 0.5, -- how many seconds to wait in between attacks
	...
	MoneyDrop = {Min = 12, Max = 18}, -- how much money (randomly) our zombie will give when killed
