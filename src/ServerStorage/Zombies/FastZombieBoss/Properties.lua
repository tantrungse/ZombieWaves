local self = {
	...
	-- Zombie stats
	HumanoidStats = {
		MaxHealth = 500, -- max possible health
		Health = 500, -- starting health
		JumpPower = 45,
	},
	ChaseSpeed = 18, -- how fast the zombie walks when it sees a player
	WanderSpeed = 8, -- how fast the zombie walks when it's just wandering
	...
	DamagePerHit = 18, -- self-explanatory
	CooldownBetweenAttack = 1, -- how many seconds to wait in between attacks
	...
	MoneyDrop = {Min = 30, Max = 40}, -- how much money (randomly) our zombie will give when killed
